    ...
    <section class="relative z-50  overflow-hidden">
        ...
        <div class="max-w-[1536px] px-4 py-[30px] mx-auto flex flex-col gap-y-8 animate__animated animate__fadeInUp">
            ...
            <div class="max-w-[1320px] m-auto relative flex flex-col justify-start items-center w-full z-50 gap-6">
                ...
                <p class="indent-12 w-full break-words ss:text-xl text-base font-afacadFlux ">Arcu nam quam erat egestas
                    ipsum arcu proin
                ...
                <p class="indent-12 w-full break-words ss:text-xl text-base font-afacadFlux "> Lorem ipsum dolor sit amet
                    ...
                    eget eget proin hac. Viverra turpis quis a sodales viverra nunc. Penatibus nunc nunc blandit sit. In non
                    amet</p>
                <p class="indent-12 w-full break-words ss:text-xl text-base font-afacadFlux "> Potenti scelerisque aliquet
                    pellentesque volutpat
                    tempor et. Nulla cras sit tempus at porta auctor dictum erat eu. Lectus ullamcorper nec nulla arcu arcu
                    eget eget proin hac. Viverra turpis quis a sodales viverra nunc. Penatibus nunc nunc blandit sit. In non
                    amet</p>

                <p class="indent-12 w-full break-words ss:text-xl text-base font-afacadFlux "> Viverra turpis quis a sodales
                    viverra nunc. Penatibus nunc nunc blandit sit. In non
                    amet</p>

                <div class="max-w-full h-auto">
                    <img src="/images/img/123122.jpg" alt="" class="w-full h-full rounded-lg">
                </div>

<div class="swiper mySwiper w-full overflow-hidden">
    <div class="swiper-wrapper">
        <div class="swiper-slide relative ">
            ...
            <div class="relative w-full h-[986px] max-xxl:h-[600px] max-2xl:h-[500px] max-lg:h-[350px] max-md:h-[250px]">
        ...
        <div class="swiper-slide relative ">
            ...
            <div class="relative w-full h-[986px] max-xxl:h-[600px] max-2xl:h-[500px] max-lg:h-[350px] max-md:h-[250px]">
                <img src="/images/banner/asabfgnhg.png" alt="Banner Image" class="w-full h-[735px] object-cover">
                <div class="absolute top-0 left-0 w-full h-full bg-black opacity-50"></div>
            </div>
